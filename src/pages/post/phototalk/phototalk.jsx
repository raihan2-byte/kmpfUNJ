    ...
    <div className="phototalk-admin">
      ...
      <form onSubmit={handleSubmit}>
        <div class="content">
          ...
          <div class="input-field">
            <input type="deskripsi" onChange={(e) => setDeskripsi(e.target.value)} placeholder="deskripsi" autocomplete="new-deskripsi" />
          </div>
          <div class="input-field">
            <input type="file" onChange={(e) => setFile(e.target.value)} placeholder="file" autocomplete="nope" />
          </div>
